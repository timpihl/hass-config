!(function(t) {
            ...
            ? ((v = n(function(t, n, r, i) {
                ...
                if (w(n)) {
                  if (
                    ...
                    return _t in n ? At(v, n) : jt.call(v, n);
                  (o = n), (p = Et(r, e));
                  var g = n.byteLength;
                  if (void 0 === i) {
  ...
  function(t, e, n) {
    ...
    function G(t, e, n, r, i, o) {
      ...
      for (var a = t[T]._b, c = u + t[F], s = r(+i), f = 0; f < e; f++)
        a[c + f] = s[o ? f : e - f - 1];
    }
    if (u.ABV) {
      if (
        ...
        for (
          ...
          if (null !== v) {
            if ((a++, 1 === v.nodeType)) {
              ...
              if (k.indexOf(s) >= 0) {
                for (
                  var O = v.parentNode, A = k.split(l), N = A.length - 1, j = 0;
                  j < N;
                  j++
                ) {
                  var T = void 0,
      ...
      It = (function(t) {
        function e() {
          return (
            ...
            jt(this, Ct(e).apply(this, arguments))
          );
        }
        var n, r, i;
        return (
...
`;
    ...
    const Ut = "light-slider-card-editor";
    ...
    class Wt extends It {
      ...
      render() {
        ...
        return (
          ...
          this._shownStateObjects.reduce(
            (t, e) => K`
        ${t}
        ${this.createCard(e)}
      `,
            K`<style>${this.styles}</style>`
          )
        );
      }
      getEntitiesToShow(t) {
      ...
      createCard(t) {
        ...
        return K`
      <ha-card class='light-slider-card ${this.config.group ? " group" : ""}'>
        ${this.createHeader(t)}
        <div class='light-slider-card-sliders ${e}'>
    ...
    `;
      ...
      createHeader(t) {
        ...
        return K`
      <div class="light-slider-card__header">
        <div class='light-slider-card__title'>${e}</div>
  ...
  textarea:focus, input:focus{
    ...
    <div class='light-slider-card-center'>
      <input .value='${t.attributes.brightness || 0}' .onchange='${e =>
              this.setBrightness(
                e,
                t
              )}'  id="slider_input" type="range" min="0" max="254" oninput="slider_output.value = Math.round(slider_input.value / 2.54 )">
      </div>

      <div class='percent' style="margin-left: 0.3vw;">
     <output .value='${Math.round(t.attributes.brightness / 2.54) ||
       0}' id="slider_output"></output><span style="margin-left: 0.05em; margin-top: -0.03em; font-size: 0.85em;">%</span>
    ...
    `
     ...
     <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser-->
     <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser-->
     <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser-->
     <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser-->
     <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser--> <!--This is a comment. Comments are not displayed in the browser-->
     ...
     <!--   <div style="display: flex; justify-content:center; padding-bottom: 0.5em;" ><ha-icon icon="hass:alert-circle-outline"></ha-icon></div>
     

     <div style="display: flex; justify-content:center; padding-bottom: 0.5em;" ><ha-icon icon="hass:alert-circle-outline" style="color: rgba(${t.attributes.rgb_color[0]}, ${t.attributes.rgb_color[1]}, ${t.attributes.rgb_color[2]}, 1); "></ha-icon></div> -->
    ...
    `;
      ...
      createWhiteValue(t) {
        return !1 === this.config.white_value
          ...
          ? K``
          : K`
      <div class="control light-slider-card-center">
    ...
    `;
      ...
      createEffectList(t) {
        ...
        return K`
      <div class="control light-slider-card-center light-slider-card-effectlist">
    ...
    `;
      ...
      createColorPicker(t) {
        return !1 === this.config.color_picker
          ...
          ? K``
          : K`
      <div class='light-slider-card__color-picker'>
        <ha-color-picker 
    ...
    `;
      ...
      generateColorPickerId(t) {
        return `light-slider-card-${t.entity_id.replace(".", "-")}`;
      }
      setColorPicker(t, e) {
    ...
    customElements.define("light-slider-card", Wt);
  }
]);
//# sourceMappingURL=light-slider-card.js.map
